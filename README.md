...
- `pipeline --json-out`、`lattice/state/eval-runs/*.json`、eval markdown summary/history、AC/drift/compliance gate JSON 和 review/TDD process evidence；
...
- loop retry state 与 eval run 的结构化联动；
