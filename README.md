...
示例会在几秒内跑通 spec-lint、AC coverage、drift check、context loader 和 pipeline smoke test。
...
| Context | 项目上下文检索、知识沉淀与中心知识同步 | `lattice/context/`、`lattice/kernel/context/` |
...
- Context loader、sync 和基础 `/learn` 约定。
