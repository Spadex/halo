...
- `pipeline --json-out`、`lattice/state/eval-runs/*.json`、`lattice/state/loops/*.json`、`lattice/state/outcomes/*.json`、`lattice/state/eval-sink/`、`lattice/state/context-runs/*.json`、`lattice/state/learn-promotions/*.json`、`lattice/state/knowledge-reviews/*.json`、`lattice/config/failure-categories.yaml`、failure category lint、`lattice/context/drafts/escalation-*.md`、eval markdown summary/history、central eval sink/static dashboard/query、outcome link/report、AC/drift/compliance gate JSON、可配置 failure category、spec-state-lint、spec-status、plan-lint、context-lint、context-run、learn draft promotion/discard、knowledge review evidence 和 review/TDD process evidence；
