...
8. Publish evidence with `eval-sink.sh publish` when the team uses a central eval sink, and refresh `eval-dashboard.sh` when the team uses the static dashboard.
...
- Optional central eval sink publish and dashboard: `lattice/state/eval-sink/`.
