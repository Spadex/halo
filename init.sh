...
for f in pipeline.sh bootstrap.sh deploy.sh eval-summary.sh eval-history.sh eval-sink.sh eval-dashboard.sh outcome-link.sh outcome-report.sh pr-comment.sh failure-category-lint.sh; do
