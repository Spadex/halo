...
for f in task-next.sh task-complete.sh task-brief.sh task-evidence-lint.sh plan-lint.sh spec-state-lint.sh spec-status.sh spec-history.sh review-package.sh review-summary.sh tdd-evidence.sh; do
