...
| 方向 | 当前证据 | 判断 |
|------|----------|------|
| PrismSpec | canonical skills、doctor.sh、guide.sh、skillpack/artifact lint.sh、spec-state-lint、spec-status、plan-lint、task-next、task-complete、task-evidence-lint、summary-draft、多模板、Plan/TDD policy | 主链路成立 |
