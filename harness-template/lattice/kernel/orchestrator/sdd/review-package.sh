...

{
  ...
  echo ""
  echo "- Spec compliance: pass | fail | cannot-verify"
  echo "- Code quality: pass | fail | cannot-verify"
  echo ""
  echo "Use \`cannot-verify\` when the diff does not contain enough evidence."
