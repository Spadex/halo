...
check_file "prismspec/skills/workflow/SKILL.md" "PrismSpec workflow skill"
check_file "prismspec/skills/specification/SKILL.md" "PrismSpec specification skill"
