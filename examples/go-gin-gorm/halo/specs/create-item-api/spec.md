...
Build a small CRUD API for item inventory and demonstrate how Halo validates spec structure, AC-to-test traceability, route drift, schema drift, and context usage.
...
- List items.
- Delete an item.
- Verify route, DDL, and AC traceability through Halo gates.
...
| `halo/context/knowledge/rules.md` | JSON, Go, and DB naming conventions must remain consistent. | Include naming rules and DDL/model drift checks. |
